...
from .models import Product, Category, Status, Blocked_User
...
#-------------------------AVISO USUARIO BLOQUEADO-------------------
    ...
    if current_user.is_authenticated:
        ...
        blocked_user = Blocked_User.query.filter_by(user_id=current_user.id).first()
        if blocked_user:
            return render_template('Aviso_Bloqueo.html') 
